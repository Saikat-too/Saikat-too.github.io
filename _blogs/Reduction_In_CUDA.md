...
In this blog, we will look at different parallel reduction techniques for computing sum in CUDA and compare the kernel execution times against PyTorch.I ran all the kernel execution and benchmarking on a **Google Colab T4 GPU**. 
